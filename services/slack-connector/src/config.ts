/**
 * Configuration for the Slack connector microservice.
 *
...
export interface AppConfig {
  ...
  /** Request timeout for outbound Slack API calls, in ms. */
...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    slackTimeoutMs: parseInt(process.env.SLACK_TIMEOUT_MS || '30000', 10),
