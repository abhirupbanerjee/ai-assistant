/**
 * Configuration for the Notion connector microservice.
 *
...
export interface AppConfig {
  ...
  /** Request timeout for outbound Notion API calls, in ms. */
...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    notionTimeoutMs: parseInt(process.env.NOTION_TIMEOUT_MS || '30000', 10),
