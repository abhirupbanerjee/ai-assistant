/**
 * Configuration for the GitHub connector microservice.
 *
...
export interface AppConfig {
  ...
  /** Request timeout for outbound GitHub API calls, in ms. */
...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    githubTimeoutMs: parseInt(process.env.GITHUB_TIMEOUT_MS || '30000', 10),
