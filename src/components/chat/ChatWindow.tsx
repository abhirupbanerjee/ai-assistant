    ...
    try {
      ...
      if (saved) {
        ...
        return {
          ...
          verbosity: parsed.verbosity === 'brief' || parsed.verbosity === 'detailed' ? parsed.verbosity : DEFAULT_CHAT_PREFERENCES.verbosity,
          customToneName: typeof parsed.customToneName === 'string' ? parsed.customToneName : undefined,
          customToneInstruction: typeof parsed.customToneInstruction === 'string' ? parsed.customToneInstruction : undefined,
