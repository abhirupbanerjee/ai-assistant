...
Rules:
- "artifact.type" must be one of the listed enum values.
- "artifact.content" is your actual work product (the deliverable).
...
- Do NOT include "agentId" or "roleFamily" in your output; the runtime injects those.`;
