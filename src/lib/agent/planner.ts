...
Subagent-safe tools (can run without human approval): web_search, web_extract, web_crawl, web_map, website_analysis, code_analysis, load_testing, chart_gen, diagram_gen, translation.
Tools that ALWAYS require human approval in subagent mode (avoid assigning subagent_enabled): doc_gen, image_gen, xlsx_gen, pptx_gen, podcast_gen, data_source, aggregate_data, file_to_html, html_gen, site_gen.
