  ...
  return {
    ...
    modelPresets: {
      ...
      'ollama-mistral': {
        ...
        description: 'Local Mistral model with tool support, no API cost',
        provider: 'ollama',
        temperature: 0.2,
        maxTokens: 2000,
        topKChunks: 15,
      ...
      'ollama-gemma3': {
        name: 'Ollama Gemma 3 12B (Local)',
        description: 'Google Gemma 3 12B local model with strong reasoning',
        provider: 'ollama',
        temperature: 0.2,
        maxTokens: 2000,
        topKChunks: 15,
