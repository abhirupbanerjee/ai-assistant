  ...
  return {
    ...
    modelPresets: {
      ...
      'mistral-large-3': {
        ...
        description: 'Mistral flagship model with 262K context, strong reasoning, tool calling, $0.50/$1.50 per 1M',
        provider: 'mistral',
        temperature: 0.2,
        maxTokens: 16000,
        topKChunks: 25,
      ...
      'mistral-medium-3': {
        name: 'Mistral Medium 3 (Balanced)',
        description: 'Balanced Mistral model with 131K context, tool calling, $0.40/$2.00 per 1M',
        provider: 'mistral',
        temperature: 0.2,
        maxTokens: 8000,
        topKChunks: 20,
      ...
      'mistral-medium-3.5': {
        ...
        description: 'Latest Medium with 256K context, open weights, strong coding, $1.50/$7.50 per 1M',
        provider: 'mistral',
        temperature: 0.2,
        maxTokens: 16000,
        topKChunks: 25,
      ...
      'mistral-small-3.2': {
        ...
        description: 'Fast and efficient Mistral model for routine queries, 128K context, $0.08/$0.20 per 1M',
        provider: 'mistral',
        temperature: 0.2,
        maxTokens: 3000,
        topKChunks: 15,
      ...
      'gemini-3-flash-preview': {
        ...
        description: 'Next-gen Flash with improved reasoning, 1M context, thinking support',
        provider: 'gemini',
        temperature: 0.2,
        maxTokens: 16000,
        topKChunks: 20,
      ...
      'gemini-3.1-pro-preview': {
        ...
        description: 'Current Pro flagship with 1M context, advanced reasoning and thinking',
        provider: 'gemini',
        temperature: 0.2,
        maxTokens: 32000,
        topKChunks: 30,
      ...
      'gemini-3.5-flash': {
        ...
        description: 'Latest Flash flagship with frontier-class performance, 1M context',
        provider: 'gemini',
        temperature: 0.2,
        maxTokens: 16000,
        topKChunks: 25,
      ...
      'gemini-3.1-flash-lite': {
        ...
        description: 'Cost-effective Flash-Lite for high-volume tasks, 1M context',
        provider: 'gemini',
        temperature: 0.2,
        maxTokens: 8000,
        topKChunks: 15,
