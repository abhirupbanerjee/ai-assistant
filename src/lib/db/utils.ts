...
export const BRANDING_ICONS = [
  ...
  // AI Assistant — neural-network glyph. `ai-icon` is the value already stored
  // in production DBs, so it is repointed to the new ai-neural PNGs. A second
  // `ai-neural` key is exposed so admins can pick it explicitly going forward.
