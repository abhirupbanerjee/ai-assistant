...
// Re-exported from utils.ts so the favicon resolver (layout.tsx) and the
// compat/admin APIs use the exact same icon list and PNG paths.
export { BRANDING_ICONS } from './utils';
