  ...
  try {
    ...
    return NextResponse.json({
      ...
      defaults: {
        ...
        memory: { enabled: true, automaticPreferenceExtractionEnabled: true, automaticInterestExtractionEnabled: true, extractionThreshold: 5, maxInterestsPerUser: 25, inferredPreferencesRequireConfirmation: false, categoryMemoryEnabled: true, categoryMemoryMaxActiveItems: 100, categoryMemoryMaxRetrievedItems: 5, categoryMemoryTokenBudget: 800, suggestionsEnabled: true, automaticCategoryCandidateExtractionEnabled: true, categoryCandidateExtractionThreshold: 6, categoryCandidateConfidenceThreshold: 0.85, categoryCandidateExtractionMaxTokens: 600, maxFactsPerCategory: 25, maxFactsPerQuery: 10, autoExtractOnThreadEnd: true, extractionMaxTokens: 1000, factMaxAgeDays: 0 },
